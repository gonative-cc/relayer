...
func (_m *MockBTCClient) GetBTCBlockByHash(blockHash *chainhash.Hash) (*types.IndexedBlock, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*chainhash.Hash) (*types.IndexedBlock, error)); ok {
		return rf(blockHash)
	}
...
func (_m *MockBTCClient) GetBTCBlockHeaderByHeight(height int64) (*wire.BlockHeader, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetBTCBlockHeaderByHeight")
	}

	var r0 *wire.BlockHeader
	var r1 error
	if rf, ok := ret.Get(0).(func(int64) (*wire.BlockHeader, error)); ok {
		return rf(height)
	}
	if rf, ok := ret.Get(0).(func(int64) *wire.BlockHeader); ok {
		r0 = rf(height)
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockBTCClient_Expecter) GetBTCBlockHeaderByHeight(height interface{}) *MockBTCClient_GetBTCBlockHeaderByHeight_Call {
	return &MockBTCClient_GetBTCBlockHeaderByHeight_Call{Call: _e.mock.On("GetBTCBlockHeaderByHeight", height)}
}
...
func (_m *MockBTCClient) GetBTCTailBlocksByHeight(height int64, fullBlocks bool) ([]*types.IndexedBlock, error) {
	ret := _m.Called(height, fullBlocks)
	...
	var r0 []*types.IndexedBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, bool) ([]*types.IndexedBlock, error)); ok {
		return rf(height, fullBlocks)
	}
	if rf, ok := ret.Get(0).(func(int64, bool) []*types.IndexedBlock); ok {
		r0 = rf(height, fullBlocks)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*types.IndexedBlock)
		}
...
func (_e *MockBTCClient_Expecter) GetBTCTailBlocksByHeight(height interface{}, fullBlocks interface{}) *MockBTCClient_GetBTCTailBlocksByHeight_Call {
	return &MockBTCClient_GetBTCTailBlocksByHeight_Call{Call: _e.mock.On("GetBTCTailBlocksByHeight", height, fullBlocks)}
}
