...
func (_m *MockBitcoinSPV) GetLatestBlockInfo(ctx context.Context) (*BlockInfo, error) {
	ret := _m.Called(ctx)
	...
	var r0 *BlockInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*BlockInfo, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *BlockInfo); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*BlockInfo)
		}
	}
...
func (_c *MockBitcoinSPV_GetLatestBlockInfo_Call) Return(_a0 *BlockInfo, _a1 error) *MockBitcoinSPV_GetLatestBlockInfo_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBitcoinSPV_GetLatestBlockInfo_Call) RunAndReturn(run func(context.Context) (*BlockInfo, error)) *MockBitcoinSPV_GetLatestBlockInfo_Call {
	_c.Call.Return(run)
	return _c
}
