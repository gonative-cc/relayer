...
var mockSignRequests = []SignRequest{
	...
	{ID: 2, Payload: rawTxBytes, DWalletID: "dwallet2",
		UserSig: "user_sig2", FinalSig: nil, Timestamp: time.Now().Unix()},
	...
	{ID: 4, Payload: rawTxBytes, DWalletID: "dwallet4",
		UserSig: "user_sig5", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 5, Payload: rawTxBytes, DWalletID: "dwallet4",
		UserSig: "user_sig5", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 6, Payload: rawTxBytes, DWalletID: "dwallet4",
		UserSig: "user_sig6", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 7, Payload: rawTxBytes, DWalletID: "dwallet4",
		UserSig: "user_sig7", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 8, Payload: rawTxBytes, DWalletID: "dwallet8",
		UserSig: "user_sig8", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 9, Payload: rawTxBytes, DWalletID: "dwallet9",
		UserSig: "user_sig9", FinalSig: nil, Timestamp: time.Now().Unix()},
	{ID: 10, Payload: rawTxBytes, DWalletID: "dwallet10",
		UserSig: "user_sig10", FinalSig: nil, Timestamp: time.Now().Unix()},
}
...
// GetMockSignRequests returns a slice of mock SignRequest structs.
func GetMockSignRequests() []SignRequest {
