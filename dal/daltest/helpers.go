...
func PopulateNativeDB(t *testing.T, db *dal.DB) []dal.NativeTx {
	...
	nativeTxs := []dal.NativeTx{
		{TxID: 10, DWalletCapID: "dwallet1", SignMessagesID: "sign1", Messages: messages, Status: dal.NativeTxStatusPending},
		{TxID: 11, DWalletCapID: "dwallet2", SignMessagesID: "sign2", Messages: messages, Status: dal.NativeTxStatusPending},
		{TxID: 12, DWalletCapID: "dwallet3", SignMessagesID: "sign3", Messages: messages, Status: dal.NativeTxStatusProcessed},
	}
